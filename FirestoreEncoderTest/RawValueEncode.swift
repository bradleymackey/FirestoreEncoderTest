...
extension RawValueEncode: Equatable where Wrapped: Equatable {
...
extension RawValueEncode: Comparable where Wrapped: Comparable {
...
extension RawValueEncode: Hashable where Wrapped: Hashable {
...
extension RawValueEncode: Codable where Wrapped.Key.RawValue: Codable, Wrapped.EncodedPayload: Codable {
